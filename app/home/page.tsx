...
const Home = () => {
  return (
    <section className="h-full e shadow-gray-50 element">
      <main className="relative flex   flex-col justify-between  ">
        ...
        >
          ...
          <p className="flex justify-end 2xl:w-[355px] w-56  text-purple-300 tracking-wider text-lg drop-shadow-2xl 2xl:text-xl 2xl:mt-1 ">
