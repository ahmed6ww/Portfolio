...
const certifications = () => {
  return (
    <div className=' h-full  '>
      ...
      <h1 className="flex justify-center mt-44 text-6xl font-extrabold tracking-wider " >Web Development</h1>
      <div className='flex justify-center gap-14 text-black  mt-32 ml-9 target '>
      ...
      <h1 className="flex justify-center mt-44 text-6xl font-extrabold tracking-wider" >Programming Langauges</h1>
      <div className='flex justify-center gap-14 text-black  mt-32 ml-9 target '>
